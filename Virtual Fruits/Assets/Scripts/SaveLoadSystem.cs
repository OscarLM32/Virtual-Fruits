...
public class SaveLoadSystem : MonoBehaviour
{
    ...
    {
        return _gameDataSave.maxReachedLevel;
    }
    ...
    {
        //Change the bit-map bit to 0 so the item does no spawn again
    ...
    private void OnEnable()
    {
        ...
        GameActions.CheckpointReached += Save;
        GameActions.LevelEndReached += Save;
    }
    ...
    private class GameData
    {
        ...
        [SerializeField]public Dictionary<int, int> collectedItems = new Dictionary<int, int>();
        [SerializeField]public Dictionary<string ,List<bool>> levelItemBitMap = new Dictionary<string, List<bool>>();
    }
}
